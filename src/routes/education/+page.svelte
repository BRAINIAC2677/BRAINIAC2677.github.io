...
<div class="container mx-auto p-4">
  ...
  <!-- Animated Navigation -->
  <div
    class="flex justify-between items-center mt-16 w-full transform transition-all duration-700 ease-out {statsVisible
      ? 'translate-y-0 opacity-100'
  ...
  >
    <!-- Previous Page -->
    <button
      class="group flex items-center space-x-2 py-3 px-6 transition-all duration-300 rounded-lg text-ink_light hover:bg-gray-100 hover:text-secondary_light md:p-3 dark:text-ink_dark dark:hover:text-secondary_dark dark:hover:bg-gray-700 hover:scale-105 hover:shadow-lg"
