<script lang="ts">
  ...
  let name = "Asif Azad";
  let title = "AI Research Engineer";
  let currentRole = "Remote AI Research Engineer at Ministry of Defence, KSA";
      ...
      <div class="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div class="space-y-3 animate-fade-in-up animate-delay-800">
            ...
            >
              ...
              >
                ...
                <span>asifazad0178@gmail.com</span>
              </div>
              <div
                class="flex items-center space-x-2 hover:text-secondary_light dark:hover:text-secondary_dark transition-colors duration-300"
              >
        ...
        >
          <div class="relative group">
            ...
            <img
              src={dp}
              alt="Asif Azad - AI Research Engineer"
      ...
      <div class="grid md:grid-cols-2 gap-8 items-start">
        ...
        >
          <p class="text-ink_light/80 dark:text-ink_dark/80 leading-relaxed">
            ...
            >
            (March 2025). When I'm not diving deep into tech innovations, you'll
            find me rewatching
            <span class="italic font-medium">The Godfather Part II</span> and
            <span class="italic font-medium">Pride and Prejudice</span>,
            competing in
            <span
        ...
        >
          ...
          >
            ...
            <p class="text-sm text-ink_light/70 dark:text-ink_dark/70">
              <span class="italic">The Biology of Belief</span> and
